      		...
      		<div id="join_box">
				<form name="member_form" method="post" action="member_modify.php?id=<?=$userid?>">
					...
					<div class="form">
						...
						<div class="col2">
							<input type="password" name="password_check" value="<?=$password?>">
						</div>                 
					</div>
					<div class="form">
					...
					<div class="form mobile_tel">
						<div class="col1">휴대폰 번호</div>
						<div class="col2">
							<input type="text" name="mobile_tel" value="<?=$mobile_tel?>">
						</div>                 
					</div>
					...
					<div class="buttons">
						<div onclick="check_input()">저장하기</div>&nbsp;
						<div><a href="index.php">취소하기</a></div>
					</div>
				</form>
        	</div> <!-- join_box -->
        </div> <!-- main_content -->
